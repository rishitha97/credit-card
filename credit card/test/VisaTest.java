...
public class VisaTest {
    ...
    public void testNoVisaCardNumber(){
        Visa v = new Visa("");
        String result = v.CardTypeValidation("");
    ...
    public void testValidateVisaCardType() {
        ...
        String result = v.CardTypeValidation("4.12E+12");
    ...
    public void testVisaCardWith14Digits() {
        ...
        String result = v.CardTypeValidation("45678901234567");
        assertEquals("Invalid", result);
    }
    ...
    public void testVisaCardWithCharacters() {
        ...
        String result = v.CardTypeValidation("45678a1234567");
        assertEquals("Invalid", result);
    }
    ...
    public void testWrongVisaNumber() {
        ...
        String result = v.CardTypeValidation("5567891234567765");
        assertEquals("Invalid", result);
    }
    ...
    public void testValid16DigitVisaCard() {
        ...
        String result = v.CardTypeValidation("4567891234567765");
        assertEquals("Visa", result);
    }
    ...
    public void test_Invalid_SpecialCharacter_In_VisaCard() {
        ...
        String result = v.CardTypeValidation("45678912_4567765");
        assertEquals("Invalid", result);
    }
}