...
public class DiscoverTest {
    ...
    public void testNoDiscoverCardNumber(){
        ...
        String result = d.CardTypeValidation("");
    ...
    public void testValidateDiscoverCardType() {
        ...
        String result = d.CardTypeValidation("6.011E+15");
    ...
    public void testFalseDiscoverCardType() {
        ...
        String result = d.CardTypeValidation("6.010E+15");
        assertEquals("Invalid", result);
    }
    ...
    public void testInvalidDiscoverCardType(){
        ...
        String result = d.CardTypeValidation("6123456789012345");
        assertEquals("Invalid", result);
    }
    ...
    public void testWrongDiscoverCardType(){
        ...
        String result = d.CardTypeValidation("1234567890126011");
        assertEquals("Invalid", result);
    }
    ...
    public void Should_ReturnInvalid_WhenCharacter_InFirstFourIndex(){
        ...
        String result = d.CardTypeValidation("6a11567890123456");
        assertEquals("Invalid", result);
    }
    ...
    public void Should_ReturnInvalid_WhenCharacter_InAnyIndex(){
        ...
        String result = d.CardTypeValidation("601156789012_456");
        assertEquals("Invalid", result);
    }
    ...
    public void testValidDiscoverCardType(){
        ...
        String result = d.CardTypeValidation("6011582364756127");
        assertEquals("Discover", result);
    }
}